...
function(generate_variables name library)
    ...
    if(UNIX AND NOT name STREQUAL "common")   #common is just the main OpenLibrary's package - don't create extra rules in FindOpenLibrary.cmake
        ...
        set(outputPaths ${CMAKE_SOURCE_DIR}/autogenerated/partial/${UP_NAME}_PATHS)
                
        #add path to header files
        foreach(header ${ARGN})
            set(headers ${OPENLIBRARY_DIR_NAME}/${library}/${header} ${headers})
        ...
        #add_custom_command(OUTPUT ${outputPaths}
        #                   COMMAND sh ARGS 
...
function(generate_variables_file)
    ...
    #as some unix commands are being used here - do not add anything on non unix systems
    if(UNIX)
        # mark ${OPENLIBRARY_REGISTERED_LIBRARIES} files as autogenerated
        foreach(file ${OPENLIBRARY_REGISTERED_LIBRARIES})
            set_source_files_properties(${file} PROPERTIES GENERATED TRUE)
        endforeach(file ${OPENLIBRARY_REGISTERED_LIBRARIES})
