...
function(generate_variables_file)
    ...
    add_custom_command(OUTPUT ${CMAKE_SOURCE_DIR}/libraries.cmake
                       COMMAND cat ARGS "${CMAKE_SOURCE_DIR}/autogenerated/partial/*" > ${CMAKE_SOURCE_DIR}/libraries.cmake
                       DEPENDS ${dependencies}
                      )

    add_custom_target(libraries.cmake
                      DEPENDS ${CMAKE_SOURCE_DIR}/libraries.cmake
                      )
